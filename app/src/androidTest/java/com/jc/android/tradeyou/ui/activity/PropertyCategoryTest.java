...
public class PropertyCategoryTest {
    ...
    public void propertyCategoryTest() {
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.text_property), withText("Property"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.text_listing_category_first_condition), withText("Trade Me Property"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Trade Me Property")));
